...
- (void)showNextVCWithScanResult:(LBXScanResult*)strResult
{
    ...
    if ([strResult.strScanned rangeOfString:@"http://"].location != NSNotFound) {
        [[UIApplication sharedApplication]openURL:[NSURL URLWithString:[NSString stringWithFormat:@"%@",strResult.strScanned]]];
    }else{
